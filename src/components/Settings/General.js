    ...
    return (
      <div style={{padding: '0 0 0 20px'}}>
        ...
        <div className="input-group">
          <span className="input-group-addon"><i className="material-icons md-48">access_time</i></span>
          <select className="form-control" name="timezones" className="selectpicker">
